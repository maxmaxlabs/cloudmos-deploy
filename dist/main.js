...
function createWindow() {
  ...
  const mainWindow = new electron__WEBPACK_IMPORTED_MODULE_0__["BrowserWindow"]({
    width: 1024,
    height: 768,
    icon: path__WEBPACK_IMPORTED_MODULE_1__["join"](__dirname, '../public/appIcon.png'),
    webPreferences: {
      preload: path__WEBPACK_IMPORTED_MODULE_1__["join"](__dirname, '../electron/preload.js'),
      webSecurity: false,
  ...
  } else {} // and load the index.html of the app.
